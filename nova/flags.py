...
global_opts = [
    ...
    cfg.StrOpt('database_topic',
               default='database',
               help='the topic database service nodes go to'),
    cfg.StrOpt('database_write_topic',
               default='database',
               help='the topic database service writes go to'),
    ...
    cfg.StrOpt('db_manager',
               default='nova.db.manager.DatabaseManager',
               help='full class name for the Manager for db service'),
